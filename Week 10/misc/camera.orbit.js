function OrbitCamera (input) {
	...
	this.getViewMatrix = function() {
		...
		let viewMatrix = this.cameraWorldMatrix.clone().inverse();
		return viewMatrix;
	}
	...
	this.getPosition = function() {
		...
		return new Vector4(this.cameraWorldMatrix.elements[3], this.cameraWorldMatrix.elements[7], this.cameraWorldMatrix.elements[11], this.cameraWorldMatrix.elements[15]);
	}
